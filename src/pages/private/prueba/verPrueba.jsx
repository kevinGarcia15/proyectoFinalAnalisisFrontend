...
export const VerPrueba = () => {
  ...
  const handleEdit = idPrueba => {
    navigate(`/prueba/editar/${idPrueba}`)
  }

  const handleRequerimiento = idPrueba=>{
    navigate(`/prueba/${idPrueba}/requerimiento`)
  }
                  ...
                  <td className="py-3 px-6 text-center">
                    <div className="flex items-center justify-center space-x-4">
                      ...
                      <Tooltip title="Agregar criterio de aceptacion">
                        <IconButton onClick={() => handleRequerimiento(prueba.idPrueba)}>
